...
\begin{sourcefiles}
  \item[Source code] src/021\_disk\_sampling.c
  \item[Analysis script] src/021\_disk\_sampling.R
  \item[Executable] exe/021\_disk\_sampling
\end{sourcefiles} 
...
result of doing that is shown in the left graph of \cref{fig:021}. While the
...
\begin{equation}
  ...
  \sqrt{u}.
\end{equation}
The graph on the right in \cref{fig:021} shows how the sampling becomes visibly
uniform with this adjustment.

\section{Box--Muller transform}\label{ex:022}

\begin{sourcefiles}
  \item[Source code] src/022\_box\_muller.c
  \item[Analysis script] src/022\_box\_muller.R
  \item[Executable] exe/022\_box\_muller
\end{sourcefiles} 
...
and you can see the results in \cref{fig:022}.
...
\begin{sourcefiles}
  ...
  \item[Analysis script] src/023\_rejection\_method.R
...
\cref{fig:023a}. A plot of the acceptance ratio as a function of $p$, starting
from the minimum value $1 / \sqrt{2}$, is shown in \cref{fig:023b}; obviously
