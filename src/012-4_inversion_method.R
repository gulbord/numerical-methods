...
plot_tex("012", plt_012, asp_ratio = 1, scale_factor = 0.75)
...
plt_013 <- fread("out/013.csv", col.names = "x") |>
  ggplot() +
    geom_histogram(
    ...
    geom_function(fun = \(x) 3 * x^2 / 8) +
    labs(x = "Sampled value", y = "Density")

plot_tex("013", plt_013, asp_ratio = 4 / 3, scale_factor = 0.75)
...
plot_tex("014a", plts_014[[1]], asp_ratio = 4 / 3, scale_factor = 0.75)
plot_tex("014b", plts_014[[2]], asp_ratio = 4 / 3, scale_factor = 0.75)
plot_tex("014c", plts_014[[3]], asp_ratio = 4 / 3, scale_factor = 0.75)
