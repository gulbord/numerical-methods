...
// The rng() is adapted from the MT19937-64 “Mersenne Twister” pseudorandom
// number generator (29/09/2004 version), by Takuji Nishimura and Makoto
// Matsumoto. The original source code is available at
